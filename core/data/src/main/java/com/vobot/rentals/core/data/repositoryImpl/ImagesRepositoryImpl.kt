...
class ImagesRepositoryImpl() : ImagesRepository {
    override val showCarousalImage =
        listOf(
    ...
    override val occasionData =
        listOf(
            ...
            Occasion(
                "Placement Day Corporate Looks",
                "https://resourcesmanager.github.io./Images/Occasion/Placement%20Day%20Corporate%20Looks.jpg",
            ),
        )
}
